...
# -= Resources =-
#
#SBATCH --job-name=TrainMask2Former-Swin-B-SimpleTransformerDecoder
#SBATCH --nodes=1
...
python train_net.py \
  --config-file configs/cityscapes/semantic-segmentation/swin/maskformer2_swin_base_IN21k_384_bs16_90k_simple_decoder.yaml --dist-url tcp://127.0.0.1:65096 \
  --num-gpus 2 SOLVER.IMS_PER_BATCH 16 SOLVER.BASE_LR 0.0001 DATALOADER.NUM_WORKERS 12 OUTPUT_DIR ./model_logs/mask2former_simple_transformer_decoder/ 
